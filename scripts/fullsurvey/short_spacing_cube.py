...
INPUT_CUBE_PATH = "/Users/antoine/Desktop/IVIS_paper/ASKAP/output_chan_1267_6_2blocks_7arcsec_lambda_r_1_positivity_true_iter_20_Nw_0.fits"
...
if __name__ == "__main__":
    ...
    for chan_idx, velocity in enumerate(velocities):
        image = np.asarray(input_data[chan_idx], dtype=float)

        sd_plane = interpolate_velocity_plane(sd_cube, velocity)
        ...
        sd_regrid_cube[chan_idx] = sd_regrid.astype(np.float32)
        feathered_cube[chan_idx] = feathered.astype(np.float32)
