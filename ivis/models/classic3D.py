...
# Classic3DHighMemory is intentionally disabled. Its former implementation
# accumulated the entire objective graph before calling backward(), unlike the
# blockwise-memory behavior of Classic3D above.
